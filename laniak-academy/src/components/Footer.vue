      ...
      >
        ...
        <div class="flex flex-col items-center md:items-start space-y-4">
          ...
          <div class="flex space-x-8">
            ...
            <div
              class="w-32 h-16 rounded flex items-center justify-center"
            >
              <img
                class="w-16 h-16"
            ...
            >
              <img
                class="w-16 h-8"
                src="https://www.cergypontoise.fr/themes/custom/cergy_pontoise/assets/images/logo-cergy-pontoise-agglo.png"
                alt=""
              />
            </div>
          </div>
        ...
        <div class="flex flex-col items-center md:items-end space-y-4">
          ...
          >
            ...
            <span class="font-medium">@laniak_basketball_academy</span>
          </a>
        </div>
      </div>
